        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Capacity = table.Column<int>(nullable: false, defaultValue: 11),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Capacity = table.Column<int>(nullable: false, defaultValue: 100)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCraftable = table.Column<bool>(nullable: false),
                    MaterialType = table.Column<string>(maxLength: 30, nullable: false),
                    Slot = table.Column<string>(nullable: false, defaultValue: "Trinket")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCraftable = table.Column<bool>(nullable: false),
                    MaterialType = table.Column<string>(maxLength: 30, nullable: false),
                    Slot = table.Column<string>(nullable: false, defaultValue: "Weapon")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArmorsEquipments", x => new { x.ArmorId, x.EquipmentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArmorsEquipments_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArmorsInventories", x => new { x.ArmorId, x.InventoryId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArmorsInventories_Inventories_InventoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsumeableInventory", x => new { x.ConsumeableId, x.InventoryId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsumeableInventory_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToolsInventories", x => new { x.ToolId, x.InventoryId });
                    table.ForeignKey(
                        name: "FK_ToolsInventories_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrinketEquipments", x => new { x.TrinketId, x.EquipmentId });
                    table.ForeignKey(
                        name: "FK_TrinketEquipments_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrinketsInventories", x => new { x.TrinketId, x.InventoryId });
                    table.ForeignKey(
                        name: "FK_TrinketsInventories_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeaponsEquipments", x => new { x.WeaponId, x.EquipmentId });
                    table.ForeignKey(
                        name: "FK_WeaponsEquipments_Equipments_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeaponsInventories", x => new { x.WeaponId, x.InventoryId });
                    table.ForeignKey(
                        name: "FK_WeaponsInventories_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialsInventories", x => new { x.MaterialId, x.InventoryId });
                    table.ForeignKey(
                        name: "FK_MaterialsInventories_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArmorsEquipments_EquipmentId",
                table: "ArmorsEquipments",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ArmorsInventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsumeableInventory_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialsInventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToolsInventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrinketEquipments_EquipmentId",
                table: "TrinketEquipments",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TrinketsInventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeaponsEquipments_EquipmentId",
                table: "WeaponsEquipments",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_WeaponsInventories_InventoryId",
